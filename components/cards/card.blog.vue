<template>
   <div class="">
      <div class="grid grid-cols-3 max-md:grid-cols-1 gap-8 bg-white">
         <div v-for="BG in BLOGS" class="flex flex-col gap-4">
            <div class="bg-white shadow-md relative rounded-lg ">
               <div class="absolute w-20 bg-white rounded-lg top-6 left-6">
                  <div
                     :style="
               ...
               <div class="w-full h-[200px] rounded-none">
                  <NuxtImg
                     ...
                     :src="BG.original_url"
                     class="rounded-none h-full w-full object-cover rounded-t-lg"
                  />
               </div>
               ...
               <div class="flex flex-col p-4 gap-2">
                  ...
                  <NuxtLink
                     ...
                     class="flex px-4 py-2 bg-gray-100 cursor-pointer mt-4 justify-between items-center w-full"
                  >
